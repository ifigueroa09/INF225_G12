...
/* ── 2bis. Alumnos con VARIAS materias ── */
...
/* ── 4. Ensayos ── */
INSERT INTO ensayos (materia_id,titulo,creador_rut) VALUES
  (1,'Ensayo PAES M1 Básico','10000000-1'),
  (2,'Ensayo PAES M2 Intermedio','20000000-2'),
  (3,'Ensayo PAES Competencia Lectora','30000000-3'),
  (4,'Ensayo PAES Historia','40000000-4'),
  (5,'Ensayo PAES Ciencias','50000000-5');

/* ── 5. Relación ensayo-pregunta ── */
INSERT INTO ensayo_pregunta (ensayo_id,pregunta_id) VALUES
  (1,1),(1,2),(1,3),
  (2,4),(2,5),(2,6),
  (3,7),(3,8),(3,9),
  (4,10),(4,11),(4,12),
...
INSERT INTO resultados_ensayo
  (ensayo_id,usuario_rut,respuestas_correctas,respuestas_incorrectas,porcentaje_buenas,porcentaje_malas)
VALUES
  (1,'11111111-1',3,0,100,0),
  (1,'22222222-2',2,1,66.67,33.33),
  (3,'11111111-1',1,2,33.33,66.67),
  (4,'33333333-3',3,0,100,0),
  (5,'33333333-3',2,1,66.67,33.33);